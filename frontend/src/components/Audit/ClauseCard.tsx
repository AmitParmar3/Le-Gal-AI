...
export const ClauseCard: React.FC<ClauseCardProps> = ({
  ...
  return (
    <div className="border border-borderSubtle bg-bgSurface mb-4 select-none">
      {/* Header Bar */}
      <div
        onClick={() => {
      ...
      >
        <div className="flex items-center space-x-3">
          <span className="font-mono text-[11px] text-textMuted bg-bgBase px-2 py-0.5 border border-borderSubtle">
            {clause.clause_id}
          </span>
          ...
          <span
            className={`font-mono text-[10px] px-2 py-0.5 uppercase tracking-wider font-bold ${
              clause.severity === "HIGH"
                ? "bg-accentRiskHigh text-red-200 border border-borderAccent"
          ...
          <span className="font-serif text-sm font-semibold text-textPrimary">
            {clause.category}
          </span>
        </div>
      ...
      {expanded && (
        <div className="p-4 space-y-4 bg-bgSurface">
          ...
          <div className="space-y-1">
            ...
            <div className="font-mono text-xs text-red-300 bg-bgBase p-2.5 border border-borderSubtle">
          ...
          <div className="space-y-1">
            ...
            <div className="font-serif text-xs text-textMuted bg-bgBase p-3 border border-borderSubtle italic leading-relaxed">
              "{clause.exact_text}"
            </div>
          </div>
          ...
          <div className="space-y-1">
            ...
            <div className="font-mono text-xs bg-bgBase p-3 border border-borderAccent leading-relaxed space-y-2">
              <div className="line-through text-[#8B263E] block">
          ...
          <div className="flex items-center justify-end space-x-3 pt-2">
            <button
              onClick={handleCopy}
              className="flex items-center space-x-1.5 font-mono text-[11px] uppercase tracking-wider text-textPrimary bg-bgBase hover:bg-borderSubtle border border-borderAccent py-2 px-3 transition-colors cursor-pointer"
            >
              {copied ? (
            ...
            <button
              ...
              className={`flex items-center space-x-1.5 font-mono text-[11px] uppercase tracking-wider text-textPrimary py-2 px-3 transition-colors cursor-pointer border border-borderSubtle ${
                accepted
                  ? "bg-emerald-950 text-emerald-200 border-emerald-800"
                  : "bg-accentPurple hover:bg-purple-950"
              }`}
            >

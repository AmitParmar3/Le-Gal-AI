...
def parse_pdf(file_path: str) -> List[Dict[str, Any]]:
    """
    Parses native PDF contract file page by page using pypdf.
    Returns list of page dictionaries with page numbers and text.
    """
...
def parent_child_chunking(
    ...
    """
    Implements Parent-Child chunking pattern per tech.md Section 2.1 & 5.1:
...
class DeterministicFallbackEmbeddings:
    ...
    used for offline development and testing when OpenAI API keys are placeholder.
    """
